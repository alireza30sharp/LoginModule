...
export class FuseScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    ...
    ngOnChanges(changes: SimpleChanges): void
    {
        ...
        if ( 'fuseScrollbar' in changes )
        {
            ...
            this.fuseScrollbar = coerceBooleanProperty((changes as any).fuseScrollbar.currentValue);
        ...
        {
            // Merge the options
            this._options = merge({}, this._options, (changes as any).fuseScrollbarOptions.currentValue);

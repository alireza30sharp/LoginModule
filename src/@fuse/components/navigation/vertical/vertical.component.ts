...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnChanges(changes: SimpleChanges): void
    {
        ...
        if ( 'appearance' in changes )
        {
            ...
            this.appearanceChanged.next((changes as any).appearance.currentValue);
        }
        ...
        if ( 'inner' in changes )
        {
            ...
            this.inner = coerceBooleanProperty((changes as any).inner.currentValue);
        }
        ...
        if ( 'mode' in changes )
        {
            ...
            const currentMode = (changes as any).mode.currentValue;
            const previousMode = (changes as any).mode.previousValue;
        ...
        {
            // Coerce the value to a boolean
            this.opened = coerceBooleanProperty((changes as any).opened.currentValue);
        ...
        {
            // Execute the observable
            this.positionChanged.next((changes as any).position.currentValue);
        }
        ...
        {
            // Coerce the value to a boolean
            this.transparentOverlay = coerceBooleanProperty((changes as any).transparentOverlay.currentValue);
        }
    }
